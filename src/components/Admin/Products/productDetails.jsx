...
const selectedProduct = {
  ...
  originalPrice: 150,
  description:
    "The Nike Air Max 270 brings a bold, new look to one of Nike's most iconic running models. Featuring a large, visible Air unit in the heel, this shoe is designed for comfort and style.",
  brand: "Nike",
  material: "Leather",
  sizes: ["S", "M", "L", "XL"],
